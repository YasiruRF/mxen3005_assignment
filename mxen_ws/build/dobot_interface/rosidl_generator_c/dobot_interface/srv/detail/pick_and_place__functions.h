...
#ifndef DOBOT_INTERFACE__SRV__DETAIL__PICK_AND_PLACE__FUNCTIONS_H_
#define DOBOT_INTERFACE__SRV__DETAIL__PICK_AND_PLACE__FUNCTIONS_H_
 ...
 * )) before or use
 * dobot_interface__srv__PickAndPlace_Request__create()
 ...
 * calls
 * dobot_interface__srv__PickAndPlace_Request__init().
...
/**
 * It calls
 * dobot_interface__srv__PickAndPlace_Request__fini()
 ...
 * dobot_interface__srv__PickAndPlace_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * dobot_interface__srv__PickAndPlace_Request__Sequence__fini()
 * on the array,
 ...
 * )) before or use
 * dobot_interface__srv__PickAndPlace_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_dobot_interface
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * dobot_interface__srv__PickAndPlace_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_dobot_interface
...
/**
 * It calls
 * dobot_interface__srv__PickAndPlace_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_dobot_interface
...
/**
 * It allocates the memory for the array and calls
 * dobot_interface__srv__PickAndPlace_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_dobot_interface
...
/**
 * It calls
 * dobot_interface__srv__PickAndPlace_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * dobot_interface__srv__PickAndPlace_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_dobot_interface
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * dobot_interface__srv__PickAndPlace_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_dobot_interface
...
/**
 * It calls
 * dobot_interface__srv__PickAndPlace_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_dobot_interface
...
/**
 * It allocates the memory for the array and calls
 * dobot_interface__srv__PickAndPlace_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_dobot_interface
...
/**
 * It calls
 * dobot_interface__srv__PickAndPlace_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // DOBOT_INTERFACE__SRV__DETAIL__PICK_AND_PLACE__FUNCTIONS_H_
