...
size_t dobot_interface__action__PosePTP_Feedback__rosidl_typesupport_introspection_c__size_function__PosePTP_Feedback__pose_present(
  const void * untyped_member)
{
  (void)untyped_member;
  return 4;
...
const void * dobot_interface__action__PosePTP_Feedback__rosidl_typesupport_introspection_c__get_const_function__PosePTP_Feedback__pose_present(
  const void * untyped_member, size_t index)
{
  const float * member =
    (const float *)(untyped_member);
...
void * dobot_interface__action__PosePTP_Feedback__rosidl_typesupport_introspection_c__get_function__PosePTP_Feedback__pose_present(
  void * untyped_member, size_t index)
{
  float * member =
    (float *)(untyped_member);
...
void dobot_interface__action__PosePTP_Feedback__rosidl_typesupport_introspection_c__fetch_function__PosePTP_Feedback__pose_present(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const float * item =
    ((const float *)
    dobot_interface__action__PosePTP_Feedback__rosidl_typesupport_introspection_c__get_const_function__PosePTP_Feedback__pose_present(untyped_member, index));
  float * value =
    (float *)(untyped_value);
  *value = *item;
}

void dobot_interface__action__PosePTP_Feedback__rosidl_typesupport_introspection_c__assign_function__PosePTP_Feedback__pose_present(
  void * untyped_member, size_t index, const void * untyped_value)
{
  float * item =
    ((float *)
    dobot_interface__action__PosePTP_Feedback__rosidl_typesupport_introspection_c__get_function__PosePTP_Feedback__pose_present(untyped_member, index));
  const float * value =
    (const float *)(untyped_value);
  *item = *value;
}
...
static rosidl_typesupport_introspection_c__MessageMember dobot_interface__action__PosePTP_Feedback__rosidl_typesupport_introspection_c__PosePTP_Feedback_message_member_array[1] = {
  {
    ...
    4,  // array size
    false,  // is upper bound
    offsetof(dobot_interface__action__PosePTP_Feedback, pose_present),  // bytes offset in struct
    NULL,  // default value
    dobot_interface__action__PosePTP_Feedback__rosidl_typesupport_introspection_c__size_function__PosePTP_Feedback__pose_present,  // size() function pointer
    dobot_interface__action__PosePTP_Feedback__rosidl_typesupport_introspection_c__get_const_function__PosePTP_Feedback__pose_present,  // get_const(index) function pointer
    dobot_interface__action__PosePTP_Feedback__rosidl_typesupport_introspection_c__get_function__PosePTP_Feedback__pose_present,  // get(index) function pointer
    dobot_interface__action__PosePTP_Feedback__rosidl_typesupport_introspection_c__fetch_function__PosePTP_Feedback__pose_present,  // fetch(index, &value) function pointer
    dobot_interface__action__PosePTP_Feedback__rosidl_typesupport_introspection_c__assign_function__PosePTP_Feedback__pose_present,  // assign(index, value) function pointer
    NULL  // resize(index) function pointer
  }
};
